/*
 ...
 XMC4700 Relax Kit is used with IFX4700T BLDC Shield on Arduino IDE.
 Preload IFX007T-Motor-Control.cpp and IFX007T-Motor-Control.h libraries.
*/

#include "IFX007T-Motor-Control.h"

#define DIRECTION  0           // 0 or 1
#define WEAKENING  0           // 0=normal, 1=weak

uint16_t rpmSpeed = 500;      //  Initial RPM decleration
...
void setup()
{
  ...
  MyMotor.MotorParam.MotorPolepairs = 8;        // Amount of polepairs. If your motor has 16 poles, it has 8 pole pairs
